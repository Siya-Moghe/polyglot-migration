...
from core.agents.agent_document import (
    node_analyze_document,
    node_validate_document,
    route_document,
    node_reflect_document,
)
...
from core.agents.agent_index import (
    node_analyze_index,
    node_validate_index,
    route_index,
    node_reflect_index,
...
from core.agents.agent_vector import (
    node_analyze_vector,
    node_validate_vector,
    route_vector,
    node_reflect_vector,
)
...
def _build_graph() -> Any:
    ...
    g.add_node("analyze_chroma", node_analyze_vector)
    g.add_node("validate_chroma", node_validate_vector)
    g.add_node("analyze_mongo", node_analyze_document)
    g.add_node("validate_mongo", node_validate_document)
    g.add_node("analyze_neo4j", node_analyze_graph)
    g.add_node("validate_neo4j", node_validate_graph)
    g.add_node("analyze_relational", node_analyze_index)
    g.add_node("validate_relational", node_validate_index)
    g.add_node("reflect_chroma",     node_reflect_vector)
    g.add_node("reflect_mongo",      node_reflect_document)
    g.add_node("reflect_neo4j",      node_reflect_graph)
    g.add_node("reflect_relational", node_reflect_index)
    ...
    g.add_conditional_edges("validate_chroma", route_vector, {"accept": "accept", "reflect": "reflect_chroma"})
    g.add_edge("reflect_chroma", "analyze_chroma")
    g.add_edge("analyze_mongo", "validate_mongo")
    g.add_conditional_edges("validate_mongo", route_document, {"accept": "accept", "reflect": "reflect_mongo"})
    g.add_edge("reflect_mongo", "analyze_mongo")
    g.add_edge("analyze_neo4j", "validate_neo4j")
    g.add_conditional_edges("validate_neo4j", route_graph, {"accept": "accept", "reflect": "reflect_neo4j"})
    g.add_edge("reflect_neo4j", "analyze_neo4j")
    g.add_edge("analyze_relational", "validate_relational")
    g.add_conditional_edges("validate_relational", route_index, {"accept": "accept", "reflect": "reflect_relational"})
    g.add_edge("reflect_relational", "analyze_relational")
